const TOOLTIP_RES = {
    ...
    corrupt: {
        ...
        desc() {
            ...
            <br class='line'>
            <i>
            Start the 16th Challenge. Earn <b>Corrupted Shards</b> based on your mass of black hole, when exiting the challenge with more than <b>${formatMass('e100')}</b> of black hole.</b>
            <span class='yellow'>You gain Corrupted Shards passively.</span><br><br>
