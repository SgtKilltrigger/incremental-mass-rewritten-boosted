...
const TREE_UPGS = {
    ...
    ids: {
        ...
        t1: {
            branch: ["m1", 'rp1'],
            req() { return player.mass.gte(E("1.5e2.700056e6")) },
            reqDesc() {return `Reach ${formatMass(E("1.5e2.700056e6"))} of mass`},
        ...
        bh2: {
            branch: ['bh1'],
            req() { return player.bh.mass.gte("1.5e1.3556e5") },
            reqDesc() {return `Reach ${format("e1.35e5")} uni of black hole`},
