const BOSONS = {
    ...
    gain: {
        ...
        hb() {
            ...
            if (player.supernova.times.gte(1) && player.inf.theorem.lt(1) && player.supernova.bosons.hb.gte(1) && x.gte(1)) x = x.mul(player.supernova.bosons.hb.max(1).log(2).max(1).pow(player.supernova.times.mul(0.2).max(1)))
