const BOSONS = {
    ...
    gain: {
        ...
        graviton() {
            ...
            if (player.supernova.bosons.graviton.gte(1) && player.inf.theorem.lt(1) && player.supernova.bosons.gluon.gte(1) && x.gte(1)) x = x.mul(player.supernova.bosons.gluon).max(1).log(10).pow(player.supernova.times.mul(0.1).max(1)) 
        ...
        hb() {
            ...
            if (player.supernova.times.gte(1) && player.inf.theorem.lt(1) && player.supernova.bosons.hb.gte(1) && x.gte(1)) x = x.mul(player.supernova.bosons.hb.max(1).log(10).pow(player.supernova.times.mul(0.2).max(1)))
